 ...
 * supaya urutan tidak pernah mentok.
 *
 * Kode permohonan memakai 6 digit (`PRM-2026-000123`), berbeda dengan kode
 * beasiswa di service Master yang 3 digit.
 */
function rakitKode(prefix, tahun, nomor, digit = 6) {
